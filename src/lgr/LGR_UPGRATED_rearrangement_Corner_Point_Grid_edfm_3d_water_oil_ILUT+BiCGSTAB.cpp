...
public:
    ...
    void generateFractures(int total_fracs = 10,
        ...
        std::cout << "Generated " << total_fracs << " natural fractures." << std::endl;
    }
    ...
    bool preprocess() {
        ...
        std::cout << "Natural fractures: " << natural_frac_count << ", aperture=" << natural_aperture << std::endl;
        std::cout << "Hydraulic fractures: " << hydraulic_frac_count << ", aperture=" << hydraulic_aperture << std::endl;
        std::cout << "LGR enabled: " << (enable_lgr ? "true" : "false") << ", d_threshold=" << d_threshold << std::endl;
